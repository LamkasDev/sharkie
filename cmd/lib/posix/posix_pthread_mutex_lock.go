...
func Pthread_mutex_trylock(mutexHandlePtr *uintptr) uintptr {
	return libScePosix_pthread_mutex_trylock(mutexHandlePtr)
}

func libScePosix_pthread_mutex_trylock(mutexHandlePtr *uintptr) uintptr {
	if mutexHandlePtr == nil {
		logger.Printf("%-132s %s failed due to invalid mutex pointer.\n",
			emu.GlobalModuleManager.GetCallSiteText(),
...
func Pthread_mutex_timedlock(mutexHandlePtr *uintptr, timestamp *Timestamp) uintptr {
	return libScePosix_pthread_mutex_timedlock(mutexHandlePtr, timestamp)
}

func libScePosix_pthread_mutex_timedlock(mutexHandlePtr *uintptr, timestamp *Timestamp) uintptr {
...
func Pthread_mutex_reltimedlock_np(mutexHandlePtr *uintptr, micros uintptr) uintptr {
	return libScePosix_pthread_mutex_reltimedlock_np(mutexHandlePtr, micros)
}

func libScePosix_pthread_mutex_reltimedlock_np(mutexHandlePtr *uintptr, micros uintptr) uintptr {
	if mutexHandlePtr == nil {
		logger.Printf("%-132s %s failed due to invalid mutex pointer.\n",
			emu.GlobalModuleManager.GetCallSiteText(),

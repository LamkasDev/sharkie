...
type FileStat struct {
	...
	AccessTime            structs.Timestamp // st_atim
	ModifyTime            structs.Timestamp // st_mtim
	ChangeStatusTime      structs.Timestamp // st_ctim
	Size                  int64             // st_size
	...
	CreateTime            structs.Timestamp // st_birthtim
}

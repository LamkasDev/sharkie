...
func (ctx *SpirvBlockContext) GetResourceBaseAddress(b *SpvBuilder, dw0, dw1 SpirvId) SpirvId {
...
func (ctx *SpirvBlockContext) GetResourceStride(b *SpvBuilder, dw1 SpirvId) SpirvId {
	typeUint := ctx.GetId(BlockContextIdTypeUint)
...
func (ctx *SpirvBlockContext) GetResourceNumRecords(b *SpvBuilder, dw2 SpirvId) SpirvId {
	return dw2
}

func (ctx *SpirvBlockContext) GetResourceSwizzleEnable(b *SpvBuilder, dw1 SpirvId) SpirvId {
	return ctx.TestMask(b, dw1, 1<<31)
}

func (ctx *SpirvBlockContext) GetResourceAddTidEnable(b *SpvBuilder, dw3 SpirvId) SpirvId {
	return ctx.TestMask(b, dw3, 1<<23)
}

func (ctx *SpirvBlockContext) GetResourceElementSize(b *SpvBuilder, dw3 SpirvId) SpirvId {
	typeUint := ctx.GetId(BlockContextIdTypeUint)
...
func (ctx *SpirvBlockContext) GetResourceIndexStride(b *SpvBuilder, dw3 SpirvId) SpirvId {
	typeUint := ctx.GetId(BlockContextIdTypeUint)
...
func (ctx *SpirvBlockContext) CalculateBufferOffset(b *SpvBuilder, stride, swizzleEn, elementSize, indexStride, addTidEnable, index, offset SpirvId) SpirvId {
	typeUint := ctx.GetId(BlockContextIdTypeUint)
...
func (ctx *SpirvBlockContext) CalculateBufferRangeCheck(b *SpvBuilder, res BufferResource, sgprOffset, index, offset, bufferOffset, idxenOrAddTidEnable SpirvId) SpirvId {
	typeUint := ctx.GetId(BlockContextIdTypeUint)

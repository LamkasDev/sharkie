...
const (
	...
	SpvCapStorageImageReadWithoutFormat       = uint32(55)
	SpvCapStorageImageWriteWithoutFormat      = uint32(56)
	SpvCapGroupNonUniformBallot               = uint32(64)
	SpvCapGroupNonUniformShuffle              = uint32(65)
	SpvCapSubgroupBallotKHR                   = uint32(4423)
	SpvCapShaderNonUniform                    = uint32(5301)
	SpvCapRuntimeDescriptorArray              = uint32(5302)
	SpvCapSampledImageArrayNonUniformIndexing = uint32(5307)
...
const (
	...
	SpvDecorationFlat           = uint32(14)
	SpvDecorationVolatile       = uint32(21)
	SpvDecorationCoherent       = uint32(23)
	SpvDecorationNonWritable    = uint32(24)
...
const (
	...
	SpvOpImageSampleDrefImplicitLod = uint32(89)
	SpvOpImageSampleDrefExplicitLod = uint32(90)
	...
	SpvOpGroupNonUniformShuffle     = uint32(345)
)

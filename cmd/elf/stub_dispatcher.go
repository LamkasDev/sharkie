...
func CreateDispatcher(goFn any) asm.StubDispatcher {
	...
	case func(*AvPlayerInitData) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*AvPlayerInitData)(unsafe.Pointer(ctx.DI))))
		}
	case func(*HttpUriElement, Cstring, uintptr, *uint64, uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*HttpUriElement)(unsafe.Pointer(ctx.DI)), Cstring(ctx.SI), ctx.DX, (*uint64)(unsafe.Pointer(ctx.CX)), uint64(ctx.R8)))
		}
	case func(*ImeDialogParam, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*ImeDialogParam)(unsafe.Pointer(ctx.DI)), ctx.SI))
		}
	case func(*ImeDialogResult) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*ImeDialogResult)(unsafe.Pointer(ctx.DI))))
		}
	case func(*ImeParam) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*ImeParam)(unsafe.Pointer(ctx.DI))))
		}
	...
	case func(*LibcFile) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*LibcFile)(unsafe.Pointer(ctx.DI))))
		}
	case func(*LibcFile, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*LibcFile)(unsafe.Pointer(ctx.DI)), ctx.SI))
		}
	case func(*LibcFile, uintptr, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*LibcFile)(unsafe.Pointer(ctx.DI)), ctx.SI, ctx.DX))
		}
	case func(*LibcFile, uintptr, uintptr, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*LibcFile)(unsafe.Pointer(ctx.DI)), ctx.SI, ctx.DX, ctx.CX))
		}
	...
	case func(*NpId, *NpId) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*NpId)(unsafe.Pointer(ctx.DI)), (*NpId)(unsafe.Pointer(ctx.SI))))
		}
	...
	case func(*SwVersion) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*SwVersion)(unsafe.Pointer(ctx.DI))))
		}
	case func(*SystemServiceDisplaySafeAreaInfo) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*SystemServiceDisplaySafeAreaInfo)(unsafe.Pointer(ctx.DI))))
		}
	...
	case func(*uintptr, Cstring, Cstring, *LibcFile) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn((*uintptr)(unsafe.Pointer(ctx.DI)), Cstring(ctx.SI), Cstring(ctx.DX), (*LibcFile)(unsafe.Pointer(ctx.CX))))
		}
	...
	case func(Cstring, *LibcFile) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(Cstring(ctx.DI), (*LibcFile)(unsafe.Pointer(ctx.SI))))
		}
	...
	case func(Cstring, Cstring, *LibcFile) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(Cstring(ctx.DI), Cstring(ctx.SI), (*LibcFile)(unsafe.Pointer(ctx.DX))))
		}
	case func(Cstring, Cstring, uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(Cstring(ctx.DI), Cstring(ctx.SI), uint64(ctx.DX)))
		}
	...
	case func(Cstring, int64, int64, *int32, *int32, *int32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(Cstring(ctx.DI), int64(ctx.SI), int64(ctx.DX), (*int32)(unsafe.Pointer(ctx.CX)), (*int32)(unsafe.Pointer(ctx.R8)), (*int32)(unsafe.Pointer(ctx.R9))))
		}
	case func(Cstring, uint16) int64:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(Cstring(ctx.DI), uint16(ctx.SI)))
		}
	case func(Cstring, uint64, int32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(Cstring(ctx.DI), uint64(ctx.SI), int32(ctx.DX)))
		}
	case func(Cstring, uintptr, uintptr, uint32, uintptr, *int32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(Cstring(ctx.DI), ctx.SI, ctx.DX, uint32(ctx.CX), ctx.R8, (*int32)(unsafe.Pointer(ctx.R9))))
		}
	...
	case func(FileDescriptor, uintptr, uint64, uintptr) int64:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(FileDescriptor(ctx.DI), ctx.SI, uint64(ctx.DX), ctx.CX))
		}
	...
	case func(SysmoduleId, uintptr, uintptr, uint64, *int32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(SysmoduleId(ctx.DI), ctx.SI, ctx.DX, uint64(ctx.CX), (*int32)(unsafe.Pointer(ctx.R8))))
		}
	case func(UserId) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(UserId(ctx.DI)))
		}
	case func(UserId, *ImeKeyboardParam) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(UserId(ctx.DI), (*ImeKeyboardParam)(unsafe.Pointer(ctx.SI))))
		}
	case func(UserId, *ImeKeyboardResourceIdArray) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(UserId(ctx.DI), (*ImeKeyboardResourceIdArray)(unsafe.Pointer(ctx.SI))))
		}
	case func(UserId, *NpId) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(UserId(ctx.DI), (*NpId)(unsafe.Pointer(ctx.SI))))
		}
	case func(UserId, *NpOnlineId) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(UserId(ctx.DI), (*NpOnlineId)(unsafe.Pointer(ctx.SI))))
		}
	...
	case func(UserId, *bool) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(UserId(ctx.DI), (*bool)(unsafe.Pointer(ctx.SI))))
		}
	...
	case func(int32, *int32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(int32(ctx.DI), (*int32)(unsafe.Pointer(ctx.SI))))
		}
	case func(int32, AudioOutPortType, int32, uint32, uint32, uint32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(int32(ctx.DI), AudioOutPortType(ctx.SI), int32(ctx.DX), uint32(ctx.CX), uint32(ctx.R8), uint32(ctx.R9)))
		}
	case func(int64, *int64, *Timesec, *uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(int64(ctx.DI), (*int64)(unsafe.Pointer(ctx.SI)), (*Timesec)(unsafe.Pointer(ctx.DX)), (*uint64)(unsafe.Pointer(ctx.CX))))
		}
	case func(int64, int32, int32, int64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(int64(ctx.DI), int32(ctx.SI), int32(ctx.DX), int64(ctx.CX)))
		}
	case func(int64, int64, *int64, *Timezone, *int32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(int64(ctx.DI), int64(ctx.SI), (*int64)(unsafe.Pointer(ctx.DX)), (*Timezone)(unsafe.Pointer(ctx.CX)), (*int32)(unsafe.Pointer(ctx.R8))))
		}
	case func(uint32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI)))
		}
	case func(uint32, *AudioOutPortState) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), (*AudioOutPortState)(unsafe.Pointer(ctx.SI))))
		}
	case func(uint32, *AvPlayerPostInitData) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), (*AvPlayerPostInitData)(unsafe.Pointer(ctx.SI))))
		}
	case func(uint32, *Cstring, *uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), (*Cstring)(unsafe.Pointer(ctx.SI)), (*uint64)(unsafe.Pointer(ctx.DX))))
		}
	case func(uint32, *HttpResponseStatusCode) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), (*HttpResponseStatusCode)(unsafe.Pointer(ctx.SI))))
		}
	case func(uint32, *MouseData, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), (*MouseData)(unsafe.Pointer(ctx.SI)), ctx.DX))
		}
	...
	case func(uint32, *uint64, *uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), (*uint64)(unsafe.Pointer(ctx.SI)), (*uint64)(unsafe.Pointer(ctx.DX))))
		}
	...
	case func(uint32, Cstring, Cstring, HttpHeaderMode) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), Cstring(ctx.SI), Cstring(ctx.DX), HttpHeaderMode(ctx.CX)))
		}
	case func(uint32, Cstring, Cstring, uint16, uint32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), Cstring(ctx.SI), Cstring(ctx.DX), uint16(ctx.CX), uint32(ctx.R8)))
		}
	case func(uint32, Cstring, uint32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), Cstring(ctx.SI), uint32(ctx.DX)))
		}
	case func(uint32, Cstring, uint32, uint32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), Cstring(ctx.SI), uint32(ctx.DX), uint32(ctx.CX)))
		}
	case func(uint32, HttpMethod, Cstring, uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), HttpMethod(ctx.SI), Cstring(ctx.DX), uint64(ctx.CX)))
		}
	case func(uint32, int32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), int32(ctx.SI)))
		}
	case func(uint32, int32, *Timeout) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), int32(ctx.SI), (*Timeout)(unsafe.Pointer(ctx.DX))))
		}
	case func(uint32, int32, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), int32(ctx.SI), ctx.DX))
		}
	case func(uint32, uint32) int64:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), uint32(ctx.SI)))
		}
	case func(uint32, uint32, *uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), uint32(ctx.SI), (*uint64)(unsafe.Pointer(ctx.DX))))
		}
	...
	case func(uint32, uint32, uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), uint32(ctx.SI), uint64(ctx.DX)))
		}
	case func(uint32, uint32, uintptr) int64:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), uint32(ctx.SI), ctx.DX))
		}
	case func(uint32, uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), uint64(ctx.SI)))
		}
	case func(uint32, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
	...
	case func(uint32, uintptr, uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint32(ctx.DI), ctx.SI, uint64(ctx.DX)))
		}
	...
	case func(uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(uint64(ctx.DI)))
		}
	...
	case func(uintptr, *LibcFile) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(ctx.DI, (*LibcFile)(unsafe.Pointer(ctx.SI))))
		}
	...
	case func(uintptr, uint32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(ctx.DI, uint32(ctx.SI)))
		}
	case func(uintptr, uint64) uintptr:
		return func(ctx *asm.RegContext) uintptr {
	...
	case func(uintptr, uint64, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(ctx.DI, uint64(ctx.SI), ctx.DX))
		}
	case func(uintptr, uintptr) uintptr:
		return func(ctx *asm.RegContext) uintptr {
	...
	case func(uintptr, uintptr, uintptr, *LibcFile) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(ctx.DI, ctx.SI, ctx.DX, (*LibcFile)(unsafe.Pointer(ctx.CX))))
		}
	case func(uintptr, uintptr, uintptr, *int32) uintptr:
		return func(ctx *asm.RegContext) uintptr {
			return uintptr(fn(ctx.DI, ctx.SI, ctx.DX, (*int32)(unsafe.Pointer(ctx.CX))))
		}
